;(function ($) {
    //默认参数
    var PARAMS;
    var DEFAULTPARAMS = { Title: "dialog", Content: "", Width: 400, Height: 300, URL: "", ConfirmFun: new Object, CancelFun: new Object };
    var ContentWidth = 0;
    var ContentHeight = 0;
    $.DialogNew = {
        //弹出提示框
    ...
    function Show(params, caller) {
        ...
        var Content = [];
        Content.push("<div id=\"DialogLayer\"></div>");
        Content.push("<div id=\"DialogNew\" style=\"width:" + PARAMS.Width + "px;height:" + PARAMS.Height + "px;left:" + positionLeft + "px;top:" + positionTop + "px;\">");
        Content.push("<div id=\"Title\"><span id=\"TitleName\">" + PARAMS.Title + "</span><span id=\"Close\">&#10005;</span></div>");
    ...
    function SetDialogEvent(caller) {
        //添加按钮关闭事件
        $("#DialogNew #Close").click(function () { $.DialogNew.Close();});
         //添加ESC关闭事件
        ...
        $(window).resize(function(){
            ...
            $("#DialogNew").css({"top":positionTop+"px","left":positionLeft+"px"});
        });
        $("#DialogNew #Title").DragBySHF($("#DialogNew"));
        if (caller != "Dialog") {
            $("#DialogNew #btnDialogConfirm").click(function () {
                $.DialogNew.Close();
        ...
        if (caller == "Confirm") {
            $("#DialogNew #btnDialogCancel").click(function () {
                $.DialogNew.Close();
