...
2. 当屏幕尺寸大于 768px 和小于等于 991px 的时，使用`.hidden-sm`控制 header 左侧的**Bootstrap 中文网**隐藏，控制右侧的**关于**隐藏。
...
header 内部使用 h2 标签包裹的标题`Bootstrap相关优质项目推荐`,设置了响应，当在大于 768px 的时候字体大小为 42px，小于 768px 的时候更改为 30px；
