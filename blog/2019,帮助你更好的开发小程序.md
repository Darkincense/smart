...
使用[runtime.js](https://github.com/facebook/regenerator/blob/master/packages/regenerator-runtime/runtime.js)，使小程序支持 async await，拷贝文件与项目目录下。
...
- [taro](https://github.com/NervJS/taro) 多端统一开发框架， React语法
