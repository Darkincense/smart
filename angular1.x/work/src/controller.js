function indexCtrl($scope, $http, $state, $injector, $location) {
...
function c10catalogueCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.myshow = false;
...
function c10classifyCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.myshow = false;
...
function c10parameterCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.myshow = false;
...
function c10seriesCtrl(cutData, $scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.myshow = false;
...
function c10assetDeviceSearchCtrl(cutData, $scope, $http) {
  $scope.customers = [];
  $scope.limits = [];
  $scope.heads = [];
  $scope.searchData = [];
...
function c10historyCtrl(cutData, $scope, $http) {
  initDatePicker();
  $scope.customers = [];
  $scope.limits = [];
  $scope.heads = [];
...
function c10alarmCtrl($scope, $http) {
...
function c10customCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = null;
  $scope.myshow = false;
...
function c10pageCtrl($scope, $http, Upload) {
  $scope.pagenum = 0;
  $scope.selectseries = "";
  $scope.num = null;
  $scope.newData = null;
...
function c10gatewayCtrl(cutData, $scope, $http) {
  $scope.pagenum = 0;
  $scope.selectseries = "";
  $scope.num = null;
  $scope.newData = {};
...
function c10machineCtrl(cutData, $scope, $http) {
  $scope.pagenum = 0;
  $scope.selectseries = "";
  $scope.num = null;
  $scope.newData = {};
...
function c10productCtrl($scope, $http, Upload) {
  $scope.numberOfElements = null;
  $scope.totalPages = null;
  $scope.data = null;
  $scope.pinId = null;
...
function c10ruleCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.modarr = null;
  $scope.newData = {};
...
function c10userCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = null;
  $scope.modshow = false;
...
function c10tenantCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.myshow = false;
...
function c10controlCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.myshow = false;
...
function c10tenantuserstateCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = null;
  $scope.myshow = false;
...
function c10tenantuserunitCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = null;
  $scope.myshow = false;
...
function c10customertenantCtrl($scope, $http) {
  $scope.pagenum = 0;
...
function c10customerunitCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = null;
  $scope.myshow = false;
...
function c10knowledgeCtrl($scope, $http) {
...
function c10certificateCtrl($scope, $http) {
...
function c10menuCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.updata = {};
...
function tenantAdminmenuCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.updata = {};
...
//系统管理员创建用户组
function tenantGroupCtrl(cutData, $scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.updata = {};
...
//租户管理员创建用户组
function tenantuserGroupCtrl(cutData, $scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.updata = {};
...
//系统管理员菜单分配
function c10allocatemenuCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.updata = {};
...
function c10history_gangguanCtrl($scope, $http, $sce, $filter) {
...
function c10ggGYZLCtrl($scope, $state, $stateParams, $http, $sce, $filter) {
...
function c10ggGYZL2Ctrl($scope, $state, $stateParams, $http, $sce, $filter) {
...
function c10ggSCWLCtrl($scope, $state, $stateParams, $http, $sce, $filter) {
  $http({
    method: "POST",
...
//租户管理员菜单分配
function c10tenantmenuallocateCtrl($scope, $http) {
  $scope.pagenum = 0;
  $scope.num = null;
  $scope.newData = {};
  $scope.updata = {};
...
angular
  ...
  .controller('c10catalogue', c10catalogueCtrl)
  .controller('c10classify', c10classifyCtrl)
  .controller('c10parameter', c10parameterCtrl)
  .controller('c10series', c10seriesCtrl) // 参数未知 Cutdata
  .controller('c10assetDeviceSearch', c10assetDeviceSearchCtrl) // 参数未知 Cutdata
  .controller('c10history', c10historyCtrl) // 参数未知 Cutdata
  .controller('c10alarm', c10alarmCtrl)
  .controller('c10custom', c10customCtrl)
  .controller('c10page', c10pageCtrl) // 参数未知 Upload
  .controller('c10gateway', c10gatewayCtrl) // 参数为知 Cutdata
  .controller('c10machine', c10machineCtrl) // 参数未知 Cutdata
  .controller('c10product', c10productCtrl) // 参数未知 Upload
  .controller('c10rule', c10ruleCtrl)
  .controller('c10user', c10userCtrl)
  .controller('c10tenant', c10tenantCtrl)
  .controller('c10control', c10controlCtrl)
  .controller('c10tenantuserstate', c10tenantuserstateCtrl)
  .controller('c10tenantuserunit', c10tenantuserunitCtrl)
  .controller('c10customertenant', c10customertenantCtrl)
  .controller('c10customerunit', c10customerunitCtrl)
  .controller('c10knowledge', c10knowledgeCtrl)
  .controller('c10certificate', c10certificateCtrl)
  .controller('c10menu', c10menuCtrl)
  .controller('tenantAdminmenu', tenantAdminmenuCtrl)
  .controller('tenantGroup', tenantGroupCtrl) // 参数未知 Cutdata
  .controller('tenantuserGroup', tenantuserGroupCtrl) // 参数未知 Cutdata
  .controller('c10allocatemenu', c10allocatemenuCtrl)
  .controller('c10history_gangguan', c10history_gangguanCtrl)
  .controller('c10ggGYZL', c10ggGYZLCtrl)
  .controller('c10ggGYZL2', c10ggGYZL2Ctrl)
  .controller('c10ggSCWL', c10ggSCWLCtrl)
  .controller('c10tenantmenuallocate', c10tenantmenuallocateCtrl)
